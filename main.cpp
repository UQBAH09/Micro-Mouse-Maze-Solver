...
vector<vector<Cell>> maze = {
    ...
    // Row 1
    {
        ...
        Cell(true,false,true,true)    // (1,14)
    },
    // Row 2
    {
        Cell(false,false,true,true),   // (2,0) 
    ...
    // Row 3
    {
        ...
        Cell(true,false,true,true)    // (3,14)
    },
    // Row 4
    {
        Cell(true,false,true,true),   // (4,0)
    ...
    // Row 5
    {
        ...
        Cell(true,false,true,true)    // (5,14)
    },
    // Row 6
    {
        Cell(true,false,true,true),   // (6,0)
    ...
    // Row 7
    {
        ...
        Cell(true,false,true,true)    // (7,14)
    },
    // Row 8
    {
        Cell(true,false,true,true),   // (8,0)
    ...
    // Row 9 
    {
        ...
        Cell(true,false,true,true)    // (9,14)
    },
    // Row 10 
    {
        Cell(true,false,true,true),   // (10,0)
    ...
    // Row 11
    {
        ...
        Cell(true,false,true,true)    // (11,14)
    },
    // Row 12
    {
        Cell(true,false,true,true),   // (12,0)
    ...
    // Row 14
    {
        ...
        Cell(false,true,false,false),  // (14,13)
        Cell(true,true,true,false)     // (14,14)
    }
};
